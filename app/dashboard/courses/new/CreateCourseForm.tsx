...
export function CreateCourseForm() {
  ...
  const [lessons, setLessons] = useState<LessonRow[]>([emptyLesson()]);
  ...
  const [quizzes, setQuizzes] = useState<QuizRow[]>([{ title: "", timeLimitMinutes: "", questions: [emptyQuestion()] }]);
